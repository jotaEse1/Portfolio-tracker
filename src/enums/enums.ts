...
/* local
    PORTFOLIO = 'http://localhost:8136/api/v1/portfolio',
    HOLDINGS = 'http://localhost:8136/api/v1/portfolio/holdings',
    UPDATEPORTFOLIO = 'http://localhost:8136/api/v1/portfolio/update'
